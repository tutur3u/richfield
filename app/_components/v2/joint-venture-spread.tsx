  ...
  return (
    ...
    >
      <div className="mx-auto flex w-full max-w-[1500px] flex-1 flex-col px-6 pb-[clamp(24px,3.5vw,48px)] pt-[calc(var(--v2-runhead)+clamp(8px,1.5vw,20px))] sm:px-10 lg:px-12">
        ...
        <p className="v2-mono v2-size-eyebrow mb-[var(--v2-rhythm)] flex items-center gap-3 text-gold">
        ...
        <div className="relative mt-[var(--v2-flow)] flex flex-1 border border-current/20">
